...
Site.modules.ShareTools = (function($, Site) {
	...
	function createLinks() {
		$(".js-share-facebook").attr("href", "https://web.archive.org/web/20240716112801/https://www.facebook.com/sharer/sharer.php?u=" + Url);
		$(".js-share-twitter_x").attr("href", "https://web.archive.org/web/20240716112801/https://twitter.com/intent/tweet?text=" + PageTitle + "&url=" + Url);
		$(".js-share-linkedin").attr("href", "https://web.archive.org/web/20240716112801/https://www.linkedin.com/shareArticle?mini=true&url=" + Url + "&title=" + PageTitle);
		$(".js-share-google").attr("href", "https://web.archive.org/web/20240716112801/https://plus.google.com/share?url=" + Url);
...
Site.modules.VideoAppender = (function($, Site) {
	...
	function insertVideo(item) {
		...
		if (href.indexOf("youtu") > -1) {
			...
			content += "<iframe class='video_item_iframe js-video-item-iframe js-video-item-youtube' tabindex='-1' src='https://web.archive.org/web/20240716112801/https://www.youtube-nocookie.com/embed/" + id + "?rel=0&controls=1&showinfo=0&autoplay=1&playsinline=1&enablejsapi=1' frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>";
		} else if (href.indexOf("vimeo") > -1) {
			id = href.match(VimeoRegExp)[5];

			content += "<iframe class='video_item_iframe js-video-item-iframe js-video-item-vimeo' tabindex='-1' src='https://web.archive.org/web/20240716112801/https://player.vimeo.com/video/" + id + "?api=1&autoplay=1&title=0&byline=0&portrait=0' style='position:absolute;top:0;left:0;width:100%;height:100%;' allow='autoplay' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><script src='https://web.archive.org/web/20240716112801/https://player.vimeo.com/api/player.js'></script>";
		}
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 24.988
  LoadShardBlock: 309.569 (3)
  PetaboxLoader3.datanode: 264.782 (6)
  PetaboxLoader3.resolve: 193.747 (2)
  load_resource: 173.743
*/