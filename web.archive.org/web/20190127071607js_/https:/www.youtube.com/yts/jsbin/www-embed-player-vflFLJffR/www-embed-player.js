...
rf("//web.archive.org/web/20190127071635/https://static.doubleclick.net/instream/ad_status.js",a);Df.push(zf(function(){Ef||"google_ad_status"in window||(xf("//web.archive.org/web/20190127071635/https://static.doubleclick.net/instream/ad_status.js",a),Ef=!0,P("DCLKSTAT",3))},5E3))}}
...
b=Ke("//web.archive.org/web/20190127071635/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Gd&&b.abort();
return Cd(a)})}
...
;function Di(a){if("1"!==bb(le(),"args","privembed")){a&&me();try{Ci().then(function(a){a=pe(a);a.bsq=Ei++;Qe("//web.archive.org/web/20190127071635/https://www.youtube.com/ad_data_204",{wa:!1,B:a,withCredentials:!0})},function(){}),T(Di,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Jf.dispose();a=0;for(var b=Df.length;a<b;a++)Cf(Df[a]);Df.length=0;wf("//web.archive.org/web/20190127071635/https://static.doubleclick.net/instream/ad_status.js");Ef=!1;P("DCLKSTAT",0);ed(Li,Ki);if(a=Ji)a.removeEventListener("onScreenChanged",Oi),a.removeEventListener("onLogClientVeCreated",Ni),a.removeEventListener("onLogServerVeCreated",Pi),a.removeEventListener("onLogVeClicked",Qi),a.removeEventListener("onLogVesShown",Ri),a.removeEventListener("onReady",Si),a.destroy();Mi=
{}});
...
/*
     FILE ARCHIVED ON 07:16:35 Jan 27, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:48:03 Dec 15, 2024.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 5.897
  LoadShardBlock: 121.474 (6)
  PetaboxLoader3.datanode: 147.867 (8)
  load_resource: 300.752 (2)
